...
public class FaultAutoSendSMS {
//	private static String user;
//	private static String phone;
//	private static String  statCode;
//
//	 public FaultAutoSendSMS(String user, String phone, String statCode) {
//	 	this.user = user;
//	 	this.phone = phone;
//	 	this.statCode = statCode;
//	 }

	 public static void sendSMS(String user,String phone,Double errCode) {
		...
		String username = "18980818879";  /*用户名*/
		//String username = "fupeng";  /*用户名 fupeng */
		
		String password_md5 = "e62559b8a07a915f8fffd47a217d540b";  /*密码*/
		//String password_md5 = "31de2dcfdba1ee589d369c12d965c662";  /*密码 fupeng */
		
		String mobile = phone;  /*手机号,只发一个号码：13800000001。发多个号码：13800000001,13800000002,...N 。使用半角逗号分隔。*/
		
		String apikey = "30b8c032c1cbe66e494b06d306f4243a";  /*apikey秘钥（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey）*/
		//String apikey = "1570e8c115c0654a90788e115a6adb00";  /*apikey秘钥 fupeng（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey） */
				
//		if(gwtr.equals(gw)){
//			content = "尊敬的"+custUame+"用户,您好!您管理的<网关>安装地址:<"+installAddr+">,故障信息:<"+faultExplain+">!";
//		}else if(gwtr.equals(mas)) {
//			content = "尊敬的"+custUame+"用户,您好!您管理的<主控器>安装地址:<"+installAddr+">,故障信息:<"+faultExplain+">!";
//		}

//		content = "尊敬的"+user+"用户,您好!您管理的<主控器>:"+installAddr+"出现电流故障,故障信息:"+errText+"!";
		content = "尊敬的"+user+",您好!您管理的<主控器节点>:"+"电源已经自动切断输出,设备当前电压为:"+errCode+"V! 请立即检查复位!";
...
//				logger.info("发送短信的状态： {} ", content);
				System.out.println("发送短信的状态:" + content);
